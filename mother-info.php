<?php
// ==========================================================
// 1. FIXED IMAGE ARRAY for all weeks (3 Images)
// The image paths remain the same as requested.
// ==========================================================
$default_images = [
    'images/mum1.jpg',
    'images/mum2.jpg',
...
// ==========================================================
// 2. PHP Data Structure: Content for key weeks (1-43)
// Content is now focused on Mother's body, symptoms, and tips.
// ==========================================================
$pregnancy_data = [
    1 => [
        'range' => '0+0 - 0+6',
        'p1' => 'This is the start of your journey, calculated from the first day of your last period. Your body is preparing for ovulation.',
        'p2' => 'Focus on boosting your health with vitamins, especially Folic Acid, to support your body when conception occurs.'
    ],
    3 => [
        'range' => '2+0 - 2+6',
        'p1' => 'Conception may occur this week! The fertilized egg begins its journey towards the uterus.',
        'p2' => 'You won’t feel different yet, but internally, hormonal changes are already beginning to set the stage for pregnancy.'
    ],
    5 => [
        'range' => '4+0 - 4+6',
        'p1' => 'You might miss your period now and get a positive pregnancy test! You may start feeling mild cramping and tender breasts.',
        'p2' => 'Fatigue and a heightened sense of smell are common. Start finding a doctor/midwife for your first prenatal appointment.'
    ],
    8 => [
        'range' => '7+0 - 7+6',
        'p1' => 'Nausea and morning sickness may be at their peak. You might also feel extreme tiredness due to rising hormones.',
        'p2' => 'Your uterus has grown to the size of a lemon. Try eating small, frequent meals to keep sickness under control.'
    ],
    12 => [
        'range' => '11+0 - 11+6',
        'p1' => 'Many first-trimester symptoms like nausea begin to fade away now. Your energy levels are likely to return!',
        'p2' => 'Your clothes may start feeling snug as your body shape changes. You might also notice thicker hair and clearer skin.'
    ],
    20 => [
        'range' => '19+0 - 19+6',
        'p1' => 'You are halfway there! You may start feeling your baby move—these first movements are called "quickening."',
        'p2' => 'Your belly button may pop out, and you might experience backaches. Maintain gentle exercise like walking or swimming.'
    ],
    30 => [
        'range' => '29+0 - 29+6',
        'p1' => 'Shortness of breath and heartburn are common as your baby pushes up on your diaphragm and stomach.',
        'p2' => 'Rest whenever you can and monitor your baby’s kicks. Braxton Hicks contractions (practice contractions) might begin this week.'
    ],
    40 => [
        'range' => '39+0 - 39+6',
        'p1' => 'You are full term! You might notice your baby "dropping" lower into your pelvis, which can ease breathing but increase pelvic pressure.',
        'p2' => 'Look for signs of labor: regular, painful contractions, water breaking, or a "bloody show." Your baby is ready to arrive!'
    ]
];

// Fill empty weeks and define trimesters (No change in logic)
$full_week_map = [];
for ($i=1;$i<=43;$i++){
    // Determine Trimester
    if($i<=13) $trimester=1; elseif($i<=27) $trimester=2; else $trimester=3;

    // Calculate Range (N-1)+0 to (N-1)+6
    $start=$i-1;
    $range="{$start}+0 - {$start}+6";

    // Use existing detailed data or fallback to the closest
    // The fallback logic remains the same (uses PHP 7.4+ short syntax)
    $content=$pregnancy_data[$i]??$pregnancy_data[max(array_filter(array_keys($pregnancy_data), fn($w)=>$w<$i))];

    // 💥 The fixed three images are assigned to all weeks here
...
// Group weeks by trimester for the grid display
$trimester_weeks=[];
